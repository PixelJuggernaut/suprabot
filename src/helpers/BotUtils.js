...
module.exports = class BotUtils {
  ...
  static async checkForUpdates() {
    const response = await getJson("https://api.github.com/repos/PixelJuggernaut/suprabot/releases/latest");
    ...
    if (response.data) {
      if (
        ...
        warn("download: https://github.com/PixelJuggernaut/suprabot/releases/latest");
      }
    }
  }
